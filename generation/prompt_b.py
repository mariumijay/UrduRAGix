...
صرف یہ اسباق استعمال کریں (جماعت نہم نصاب):
نام دیو مالی (مولوی عبد الحق) | آرام و سکون (امتیاز علی تاج) | بھیڑیا (غلام عباس) |
ابتدائی حساب (ابن انشا) | اپنی مدد آپ (سید سلیمان ندوی) |
اخلاق حسنہ (سرسید احمد خاں) | کلیم اور مرزا (ڈپٹی نذیر احمد) | لڑی میں پروئے ہوئے منظر (رضا علی عابدی)

(الف) سبق "[پہلا سبق — اوپر کی فہرست سے]" از [مصنف] کا خلاصہ اپنے الفاظ میں لکھیں۔

(ب)  سبق "[دوسرا مختلف سبق — اوپر کی فہرست سے]" از [مصنف] کا خلاصہ اپنے الفاظ میں لکھیں۔

اہم ہدایت:
• صرف سوال نمبر ۵ تیار کریں، اور کچھ نہیں۔
• سوال نمبر 1، 2، 3 یا 4 ہرگز مت لکھیں!
...
صرف یہ نظمیں استعمال کریں (جماعت نہم نصاب):
محنت کی برکات (مولانا حالی) | جاوید کے نام (علامہ محمد اقبال) |
پیام لطیف (شیخ ایاز) | نعت (مولانا ظفر علی خاں) |
محمد (مظفر وارثی) | ت اور مشاعرہ (دلاور فگار)

نظم: "[اوپر کی فہرست سے کوئی ایک — Q2 میں نہ آئی ہو]"
شاعر: [شاعر کا نام]
